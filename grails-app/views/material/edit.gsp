...
<html>
	<head>
		...
		<!-- PAGE TITLE -->
		<title><g:message code="material.edit.label" /></title>
	...
	<body>
		...
		<div class="nav" role="navigation">
			<ul>
				...
				<li><g:link class="list" action="index"><g:message code="Lista de Materiales"/></g:link></li>
		...
		<div id="edit-material" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:materialInstance, action:'update']" method="PUT" >
				...
				<fieldset class="form">
					<!--This renders a template for the material fields -->					
